...
_root = '/data_4t/xk/datasets/ReID'     # 2020.10.23，不设置环境变量，将所有数据均置于此处
...
def build_reid_train_loader(cfg):
    ...
    # 上述data_sampler自行实现了为各GPU读取不同数据子集的功能，因此没有用torch.utils.data.distributed.DistributedSampler()
...
def fast_batch_collator(batched_inputs):
    ...
    # container_abcs.Mapping： A Mapping is a generic container for associating key/value pairs
    # container_abcs.Sequence：All the operations on a read-only sequence.
