...
class IterationTimer(HookBase):
    ...
    def after_train(self):
        ...
        if num_iter > 0 and total_time_minus_hooks > 0:
            ...
            logger.info(
                ...
                )   # 输出示例: Overall training speed: 24237 iterations in 1:47:05 (0.2651 s / it)
            )
        ...
        logger.info(
            ...
            )       # 输出示例: Total training time: 1:54:31 (0:07:25 on hooks)
        )
    ...
    def after_step(self):
        ...
        if iter_done >= self._warmup_iter:
            ...
            self.trainer.storage.put_scalars(time=sec)      # time记录一个iteration的耗时
        else:
            self._start_time = time.perf_counter()
