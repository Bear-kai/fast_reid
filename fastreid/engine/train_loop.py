...
class TrainerBase:
    ...
    def register_hooks(self, hooks):
        ...
        for h in hooks:
            ...
            # 参考链接: https://docs.python.org/zh-cn/3/library/weakref.html
    ...
    def train(self, start_iter: int, max_iter: int):
        ...
        with EventStorage(start_iter) as self.storage:
            ...
            # 执行完try中的代码后(即使有异常抛出)，一定会执行finally
            finally:
                self.after_train()
...
class SimpleTrainer(TrainerBase):
    ...
    def run_step(self):
        ...
        # 相关链接:
        # https://pytorch.apachecn.org/docs/1.4/59.html
        # https://pytorch.org/docs/stable/_modules/torch/cuda/streams.html
